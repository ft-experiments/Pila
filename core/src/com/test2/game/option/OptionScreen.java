...
public class OptionScreen extends ScreenAdapter implements Screen {
    ...
    public void render(float delta) {
        ...
        if (Background_1.h > Background_2.h) {
            ...
            temp = 1;
        } else if (Background_2.h > Background_3.h) {
            Var.actbackground = Var.background2;
            temp = 2;
        } else if (Background_3.h > Background_4.h) {
            Var.actbackground = Var.background3;
            temp = 3;
        } else if (Background_4.h > Background_5.h) {
            Var.actbackground = Var.background4;
            temp = 4;
        } else if (Background_5.h > Background_6.h) {
            Var.actbackground = Var.background5;
            temp = 5;
        } else if (Background_6.h > Background_7.h) {
            Var.actbackground = Var.background6;
            temp = 6;
        } else if (Background_7.h > Background_8.h) {
            Var.actbackground = Var.background7;
            temp = 7;
        } else if (Background_8.h > Background_9.h) {
            Var.actbackground = Var.background8;
            temp = 8;
        } else if (Background_9.h > Background_10.h) {
            Var.actbackground = Var.background9;
            temp = 9;
        } else if (Background_10.h > 0) {
