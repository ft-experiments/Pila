...
/////////////////////////DAS//PAUSEPOPUP//ENDED//HIER//////////////////////////////
    ...
    //ablauf der objekte
        if(Var.ballmode==1){
            ...
            shapeRenderer.rect(0,Gdx.graphics.getHeight()-25, Ablauf.feuerballablauf/5,(Gdx.graphics.getHeight()/26));
        ...
        if(Var.kleben==1){
            ...
            shapeRenderer.rect(0,Gdx.graphics.getHeight()-50, Ablauf.klebablaufsoll/5,(Gdx.graphics.getHeight()/26));
