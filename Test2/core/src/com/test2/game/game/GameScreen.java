...
//System.out.println(Var.gamestatus);
        if (Var.gamestatus == 0) {    //Ball erstellen
            if(Var.ballstartmode==0) {
                ...
                new Ball((int) (Var.r_x + Var.r_l / 2) - Ball.r, (int) (Var.r_y + 100), (Gdx.graphics.getWidth()* Gdx.graphics.getHeight())/127872, 0f, -15f, 0.0f, 1f);
                Var.gamestatus = 1;
...
/////////////////////////DAS//PAUSEPOPUP//ENDED//HIER//////////////////////////////
    ...
    //ablauf der objekte
        if(Var.ballmode==1){
            ...
            shapeRenderer.rect(0,Gdx.graphics.getHeight()-25, Ablauf.feuerballablauf/5,Gdx.graphics.getHeight()/25/2);
        ...
        if(Var.kleben==1){
            ...
            shapeRenderer.rect(0,Gdx.graphics.getHeight()-50, Ablauf.klebablaufsoll/5,Gdx.graphics.getHeight()/25);
